...
class successive_hill_climbing : public ck_search {

public:

	/*inline successive_hill_climbing(systemState Problem);*/

	successive_hill_climbing();

	successive_hill_climbing(const char*);
